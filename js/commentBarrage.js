const commentBarrageConfig = {
  //颜色
  colors: [
    ['rgba(56,106,178,.7)', 'rgba(255,255,255,0.8)'],
    ['rgba(146,72,240,.7)', 'rgba(255,255,255,0.8)'],
    ['rgba(45,165,93 ,.7)', 'rgba(255,255,255,0.8)'],
    ['rgba(255,197,5 ,.7)', 'rgba(255,255,255,0.8)'],
    ['rgba(212,78, 48,.7)', 'rgba(255,255,255,0.8)'],
    ['rgba(212,78, 48,.7)', 'rgba(255,255,255,0.8)'],
    ['rgba(44,192, 24,.7)', 'rgba(255,255,255,0.8)'],
    ['rgba(21,209,209,.7)', 'rgba(255,255,255,0.8)'],
    ['rgba(190,10,210,.7)', 'rgba(255,255,255,0.8)']
  ],
  //同时最多显示弹幕数
  maxBarrage: 2,
  //弹幕显示间隔时间ms
