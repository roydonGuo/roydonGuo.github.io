const commentBarrageConfig = {
  ...
  colors: [
    ...
    ['rgba(212, 78, 48,0.5)', 'rgba(255,255,255,0.6)'],
    ['rgba(44, 192, 24,0.5)', 'rgba(255,255,255,0.6)'],
    ['rgba(21, 209, 209,0.5)', 'rgba(255,255,255,0.6)'],
    ['rgba(190, 10, 210,0.5)', 'rgba(255,255,255,0.6)']
  ],
  //同时最多显示弹幕数
  maxBarrage: 2,
  //弹幕显示间隔时间ms
