    ...
    for (var i = start;i<endFor;i++){
      ...
      <div class="cf-article">
        ...
        <div class="cf-article-avatar no-lightbox flink-item-icon">
          <a onclick="openMeShow(event)" data-link="${item.link}" class="" target="_blank" rel="noopener nofollow" href="javascript:;"><img class="cf-img-avatar avatar" src= "data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7" data-lazy-src="${item.avatar}" alt="avatar" onerror="this.src='${fcdata.error_img}'; this.onerror = null;"><span class="cf-article-author">${item.author}</span></a>
  ...
  var showHtml = `
      <div class="cf-overshow">
        <div class="cf-overshow-head">
          <img class="cf-img-avatar avatar" src= "data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7" data-lazy-src="${userinfo.avatar}" alt="avatar" onerror="this.src='${fcdata.error_img}'; this.onerror = null;">
